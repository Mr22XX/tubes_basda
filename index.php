        ...
        <div class=" flex  items-center lg:justify-start md:justify-center sm:justify-center ml-10 h-[calc(100%-4rem)] p-1">
            <div class=" h-72  rounded-lg w-96 lg:p-36 md:p-10 flex justify-center  flex-col gap-3">
               ...
               <div class="flex gap-4 w-80 lg:h-20  text-center">
                   <a  href="" class=" text-center w-32 bg-green-500 text-white font-semibold py-2 px-4 rounded shadow hover:bg-green-600 active:bg-green-700 cursor-pointer">Jadwal Kelas</a>
                   <a  href="" class=" text-center w-32 bg-blue-500 text-white font-semibold py-2 px-4 rounded shadow hover:bg-blue-600 active:bg-blue-700 cursor-pointer">Lihat Materi</a>
                </div>
